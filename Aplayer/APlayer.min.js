  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          n(a, function (e, n) {
            (t += "\n    <p"), 0="==" n && (t +=" class="aplayer-lrc-current"" ), ); }), t }; }, function (e, t, n) { "use strict"; object.defineproperty(t, "__esmodule", value: !0 }); var i, a="(function" () e(e, t) for (var < t.length; n++) i="t[n];" (i.enumerable="i.enumerable" || !1), (i.configurable="!0)," "value" in (i.writable="!0)," object.defineproperty(e, i.key, i); } return (t, n, i) e(t.prototype, n), e(t, i), t; })(), r="n(10)," o="(i" = r) i.__esmodule ? : default: s="(function" e(t) !(function if (!(e instanceof t)) throw new typeerror("cannot call class as function"); })(this, e), (this.container="t.container)," (this.async="t.async)," (this.player="t.player)," (this.parsed="[])," (this.index="0)," (this.current="[]);" ( a(e, [ key: "show", this.player.events.trigger("lrcshow"), this.player.template.lrcwrap.classlist.remove( "aplayer-lrc-hide" "hide", this.player.events.trigger("lrchide"), this.player.template.lrcwrap.classlist.add( "toggle", this.player.template.lrcwrap.classlist.contains( ) this.show() this.hide(); "update", e="arguments.length"> 0 && void 0 !== arguments[0]
                    ? arguments[0]
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          a.fixed
            ? ((t += '\n<div 1 class="aplayer-list'),
              a.listFolded && (t += " aplayer-list-hide"), (t +=""" ), a.listmaxheight && ((t )), l(n(1)(u({ theme: a.theme, audio: a.audio, index: }))), r "list"="==" a.order ? : "random"="==" "one"="==" a.loop "all"="==" "none"="==" )) a.listfolded t ); }; }, function (e, t, n) { "use strict"; object.defineproperty(t, "__esmodule", value: !0 }); var i="(function" () e(e, t) for (var n="0;" < t.length; n++) (i.enumerable="i.enumerable" || !1), (i.configurable="!0)," "value" in (i.writable="!0)," object.defineproperty(e, i.key, i); } return (t, n, i) e(t.prototype, n), e(t, i), t; })(), a="o(n(3))," o(e) e e.__esmodule default: s="(function" e(t) !(function if (!(e instanceof t)) throw new typeerror("cannot call as function"); })(this, e), (this.container="t.container)," (this.options="t.options)," (this.randomorder="t.randomOrder)," this.init(); ( i(e, [ key: "init", ; this.options.audio.length (e="random" =="=" this.options.order this.options.audio[this.randomorder[0]].cover this.options.audio[0].cover), (this.container.innerhtml="(0," r.default)({ options: this.options, icons: a.default, cover: e, getobject: (e) e; })), (this.lrc="this.container.querySelector(" ".aplayer-lrc-contents" (this.lrcwrap="this.container.querySelector(".aplayer-lrc"))," (this.ptime="this.container.querySelector(".aplayer-ptime"))," (this.info="this.container.querySelector(".aplayer-info"))," (this.time="this.container.querySelector(".aplayer-time"))," (this.barwrap="this.container.querySelector(".aplayer-bar-wrap"))," (this.button="this.container.querySelector(".aplayer-button"))," (this.body="this.container.querySelector(".aplayer-body"))," (this.list="this.container.querySelector(".aplayer-list"))," (this.listol="this.container.querySelector(".aplayer-list" ol")), (this.listcurs="this.container.querySelectorAll(".aplayer-list-cur"))," (this.played="this.container.querySelector(".aplayer-played"))," (this.loaded="this.container.querySelector(".aplayer-loaded"))," (this.thumb="this.container.querySelector(".aplayer-thumb"))," (this.volume="this.container.querySelector(".aplayer-volume"))," (this.volumebar="this.container.querySelector(" ".aplayer-volume-bar" (this.volumebutton="this.container.querySelector(" ".aplayer-time button" (this.volumebarwrap="this.container.querySelector(" ".aplayer-volume-bar-wrap" (this.loop="this.container.querySelector(".aplayer-icon-loop"))," (this.order="this.container.querySelector(" ".aplayer-icon-order" (this.menu="this.container.querySelector(".aplayer-icon-menu"))," (this.pic="this.container.querySelector(".aplayer-pic"))," (this.title="this.container.querySelector(".aplayer-title"))," (this.author="this.container.querySelector(".aplayer-author"))," (this.dtime="this.container.querySelector(".aplayer-dtime"))," (this.notice="this.container.querySelector(".aplayer-notice"))," (this.miniswitcher="this.container.querySelector(" ".aplayer-miniswitcher" (this.skipbackbutton="this.container.querySelector(".aplayer-icon-back"))," (this.skipforwardbutton="this.container.querySelector(" ".aplayer-icon-forward" (this.skipplaybutton="this.container.querySelector(".aplayer-icon-play"))," (this.lrcbutton="this.container.querySelector(".aplayer-icon-lrc"));" ]), })(); t.default="s;" }), (t.default="function" container: e.element document.getelementsbyclassname("aplayer")[0], mini: e.narrow e.fixed !1, fixed: autoplay: mutex: !0, lrctype: e.showlrc e.lrc 0, preload: "auto", "#b7daff", loop: "all", order: "list", volume: 0.7, listfolded: e.fixed, listmaxheight: e.listmaxheight "250px", e.music [], storagename: "aplayer-setting", t.hasownproperty(n) !e.hasownproperty(n) (e[n]="t[n]);" "[object array]" !="=" object.prototype.tostring.call(e.audio) (e.audio="[e.audio])," e.audio.map(function (e.name="e.name" e.title "audio name"), (e.artist="e.artist" e.author artist"), (e.cover="e.cover" e.pic), (e.type="e.type" "normal"), e.audio.length e.loop (e.loop="all" e.exports="<svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 32 32"><path d="M26.667 5.333h-21.333c-0 0-0.001 0-0.001 0-1.472 0-2.666 1.194-2.666 2.666 0 0 0 0.001 0 0.001v-0 16c0 0 0 0.001 0 0.001 0 1.472 1.194 2.666 2.666 2.666 0 0 0.001 0 0.001 0h21.333c0 0 0.001 0 0.001 0 1.472 0 2.666-1.194 2.666-2.666 0-0 0-0.001 0-0.001v0-16c0-0 0-0.001 0-0.001 0-1.472-1.194-2.666-2.666-2.666-0 0-0.001 0-0.001 0h0zM5.333 16h5.333v2.667h-5.333v-2.667zM18.667 24h-13.333v-2.667h13.333v2.667zM26.667 24h-5.333v-2.667h5.333v2.667zM26.667 18.667h-13.333v-2.667h13.333v2.667z"></path></svg>" i, a, {}); o() error("settimeout has not been defined"); s() error("cleartimeout l(e) (i="==" settimeout) settimeout(e, 0); ((i="==" o !i) try catch (t) i.call(null, i.call(this, settimeout o; cleartimeout s; u, c="[]," p="!1," d="-1;" h() u ((p="!1)," u.length (c="u.concat(c))" (d="-1)," c.length y()); y() (!p) ) (u="c," ++d u[d].run(); (p="!1)," (function (a="==" cleartimeout) cleartimeout(e); ((a="==" !a) a(e); a.call(null, e); a.call(this, })(e); f(e, (this.fun="e)," (this.array="t);" v() {} (r.nexttick="function" array(arguments.length - 1); (arguments.length> 1)
